	...
	<div class="contact-table">
		<ul class="nav nav-tabs" id="myTab" role="tablist">
		  <li class="nav-item" role="presentation">
		    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#antalya-contact" type="button" role="tab" aria-controls="home" aria-selected="true">Antalya</button>
		  </li>
		  <li class="nav-item" role="presentation">
		    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#dubai-contact" type="button" role="tab" aria-controls="profile" aria-selected="false">Dubai</button>
		  </li>
		  <li class="nav-item" role="presentation">
		    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#nursultan-contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Nur-Sultan</button>
		  </li>
		  <li class="nav-item" role="presentation">
		    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#paris-contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Paris</button>
		  </li>
		  <li class="nav-item" role="presentation">
		    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#california-contact" type="button" role="tab" aria-controls="contact" aria-selected="false">California</button>
		  </li>
		</ul>
